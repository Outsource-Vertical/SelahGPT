...
export default function EditHealthProfileScreen({ route, navigation }) {
  ...
  const [recentSymptoms, setRecentSymptoms] = useState(
    profile.recentSymptoms?.join(", ") || "",
  );
  const [mentalHealthFocus, setMentalHealthFocus] = useState(
    profile.mentalHealthFocus || "",
  );
  const [wantsHealthEncouragement, setWantsHealthEncouragement] = useState(
    profile.wantsHealthEncouragement || false,
  );
  ...
  return (
    <ScrollView style={{ padding: 16 }}>
      ...
      <TextInput
        ...
        onChangeText={setRecentSymptoms}
        style={inputStyle}
      />

      <Text>Mental Health Focus</Text>
      <TextInput
        value={mentalHealthFocus}
        onChangeText={setMentalHealthFocus}
        style={inputStyle}
      />
      ...
      >
        ...
        <Switch
          value={wantsHealthEncouragement}
          onValueChange={setWantsHealthEncouragement}
        />
      </View>
