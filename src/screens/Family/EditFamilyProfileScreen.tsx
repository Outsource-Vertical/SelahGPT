...
export default function EditFamilyProfileScreen({ route, navigation }) {
  ...
  const [currentFamilyFocus, setCurrentFamilyFocus] = useState(
  ...
  return (
    <ScrollView style={{ padding: 16 }}>
      ...
      <TextInput
        value={majorFamilyDates}
        onChangeText={setMajorFamilyDates}
        style={inputStyle}
      />

      <Text>Current Focus</Text>
      <TextInput
        value={currentFamilyFocus}
        onChangeText={setCurrentFamilyFocus}
        style={inputStyle}
      />

      <Text>Family Challenges</Text>
      <TextInput
        value={familyChallenges}
        onChangeText={setFamilyChallenges}
        style={inputStyle}
      />
      ...
      >
        ...
        <Switch
          value={wantsFamilyEncouragement}
          onValueChange={setWantsFamilyEncouragement}
        />
      </View>
